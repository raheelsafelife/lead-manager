...
from app import crud_users, crud_leads, services_stats, crud_activity_logs, crud_agencies, crud_email_reminders, crud_ccus, crud_mcos
...
def dashboard():
    ...
    if show_cumulative:
        ...
        with col1:
            ...
            if staff_data:
                ...
                event_staff = st.plotly_chart(fig_staff, use_container_width=True, on_select="rerun", selection_mode="points", key="staff_chart", config=chart_config)
        ...
        with col2:
            ...
            if source_data:
                ...
                event_source = st.plotly_chart(fig_source, use_container_width=True, on_select="rerun", selection_mode="points", key="source_chart_cum", config=chart_config)
        ...
        with col1:
            ...
            if monthly_data:
                ...
                event_monthly = st.plotly_chart(fig_monthly, use_container_width=True, on_select="rerun", selection_mode="points", key="monthly_chart_ind", config=chart_config)
        ...
        with col2:
            ...
            if source_data:
                ...
                event_source_ind = st.plotly_chart(fig_source_ind, use_container_width=True, on_select="rerun", selection_mode="points", key="source_chart_ind", config=chart_config)
    ...
    with col1:
        ...
        try:
            ...
            if status_data:
                ...
                event_status = st.plotly_chart(fig_status, use_container_width=True, on_select="rerun", selection_mode="points", key="status_chart", config=chart_config)
    ...
    with col2:
        ...
        if monthly_data:
            ...
            event_monthly_trend = st.plotly_chart(fig_monthly_trend, use_container_width=True, on_select="rerun", selection_mode="points", key="monthly_chart_trend", config=chart_config)
    ...
    with col1:
        ...
        if event_data:
            ...
            event_chart = st.plotly_chart(fig_event, use_container_width=True, on_select="rerun", selection_mode="points", key="event_chart", config=chart_config)
    ...
    with col2:
        ...
        if wom_data:
            ...
            event_wom = st.plotly_chart(fig_wom, use_container_width=True, on_select="rerun", selection_mode="points", key="wom_chart", config=chart_config)
    ...
    if not show_cumulative and active_leads > 0:
        ...
        with col1:
            ...
            if referral_monthly:
                ...
                event_ref_monthly = st.plotly_chart(fig_ref_monthly, use_container_width=True, on_select="rerun", selection_mode="points", key="ref_monthly_chart", config=chart_config)
        ...
        with col2:
            ...
            if ref_status_data:
                ...
                event_ref_status = st.plotly_chart(fig_ref_status, use_container_width=True, on_select="rerun", selection_mode="points", key="ref_status_chart", config=chart_config)
        ...
        with col1:
            ...
            if auth_data:
                ...
                event_auth = st.plotly_chart(fig_auth, use_container_width=True, on_select="rerun", selection_mode="points", key="auth_chart", config=chart_config)
        ...
        with col2:
            ...
            if care_data:
                ...
                event_care = st.plotly_chart(fig_care, use_container_width=True, on_select="rerun", selection_mode="points", key="care_chart", config=chart_config)
    ...
    with col1:
        ...
        if referral_status_data:
            ...
            event_ref_status_shared = st.plotly_chart(fig_ref_status_shared, use_container_width=True, on_select="rerun", selection_mode="points", key="ref_status_shared_chart", config=chart_config)
    ...
    with col2:
        ...
        if auth_data:
            ...
            event_auth_shared = st.plotly_chart(fig_auth_shared, use_container_width=True, on_select="rerun", selection_mode="points", key="auth_shared_chart", config=chart_config)
    ...
    with col1:
        ...
        if total_leads > 0:
            try:
                ...
                st.plotly_chart(fig_confirm, use_container_width=True, key="confirm_chart", config=chart_config)
                ...
                with col_btn1:
                    if st.button("📊 View Referrals", key="btn_referrals", use_container_width=True):
    ...
    with col2:
        ...
        if total_leads > 0:
            ...
            st.plotly_chart(fig_convert, use_container_width=True, key="convert_chart", config=chart_config)
            ...
            with col_btn1:
                if st.button("📊 Care Start", key="btn_care_start", use_container_width=True):
            ...
            with col_btn2:
                if st.button("📊 Not Start", key="btn_not_start", use_container_width=True):
            ...
            with col_btn3:
                if st.button("📊 Pending", key="btn_conv_pending", use_container_width=True):
...
def discovery_tool():
    ...
    selection = st.plotly_chart(fig, use_container_width=True, on_select="rerun", selection_mode="points", key="discovery_chart_main", config=chart_config)
        ...
        with st.expander(f"{user.username} ({user.role})", expanded=False):
            ...
            with col_p1:
                ...
                if total_leads > 0:
                    ...
                    st.plotly_chart(fig_confirm, use_container_width=True, config=chart_config, key=f"pie_conf_{user.id}")
                    ...
                    with col_btn1:
                        if st.button("📊 Referrals", key=f"btn_ref_{user.id}", use_container_width=True):
                            # Toggle drill-down
                    ...
                    with col_btn2:
                        if st.button("📊 Pending", key=f"btn_pend_{user.id}", use_container_width=True):
                            # Toggle drill-down
                            session_key = f'drill_admin_conf_{user.id}'
            ...
            with col_p2:
                ...
                if total_leads > 0:
                    ...
                    st.plotly_chart(fig_convert, use_container_width=True, config=chart_config, key=f"pie_conv_{user.id}")
                    ...
                    with col_btn1:
                        if st.button("📊 Care Start", key=f"btn_cs_{user.id}", use_container_width=True):
                    ...
                    with col_btn2:
                        if st.button("📊 Not Start", key=f"btn_ns_{user.id}", use_container_width=True):
                            session_key = f'drill_admin_conv_{user.id}'
                    ...
                    with col_btn3:
                        if st.button("📊 Pending", key=f"btn_cp_{user.id}", use_container_width=True):
                            session_key = f'drill_admin_conv_{user.id}'
            ...
            with col1:
                ...
                if monthly_data:
                    ...
                    event_monthly = st.plotly_chart(fig_monthly, use_container_width=True, on_select="rerun", selection_mode="points", config=chart_config, key=f"line_{user.id}")
            ...
            with col2:
                ...
                if source_data:
                    ...
                    event_source = st.plotly_chart(fig_source, use_container_width=True, on_select="rerun", selection_mode="points", config=chart_config, key=f"bar_src_{user.id}")
